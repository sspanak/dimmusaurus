"""
Django settings for pysaurus project.
...
SECRET_KEY = '=j!f(!3i2v0n&4rkg$ae5c_va_@7k+ysuv=!pso5s&5&qz(mm^'
...
WSGI_APPLICATION = 'pysaurus.wsgi.application'
